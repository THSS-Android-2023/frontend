package com.example.internet.chatkit.fixtures;
...
abstract class FixturesData {
    ...
    static ArrayList<String> avatars = new ArrayList<String>() {
        {
            add("https://i.328888.xyz/2023/05/16/ViAkp5.jpeg");
            add("https://i.328888.xyz/2023/05/16/ViAlAZ.jpeg");
            add("https://i.328888.xyz/2023/05/16/ViA098.jpeg");
            add("https://i.328888.xyz/2023/05/16/ViAwNF.jpeg");
        }
    };
