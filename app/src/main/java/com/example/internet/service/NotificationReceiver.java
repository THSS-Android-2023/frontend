    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                NotificationUtil.notify(activity,  notificationModel.type, notificationModel.id, jwt, username, notificationModel.nickname, "CampusXpress", notificationModel.content);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
